...
// - 반환타입
// : 부모 클래스의 메서드 반환타입과 같거나 자동 형변환이 가능한 것이어야함
// - @override(어노테이션)
// : 오버라이딩된 메서드임을 명시적으로 표시

//! 오버라이딩의 구현 방법
// 1. 부모 클래스의 상속받은 메서드를 하위 클래스에서 다시 정의
// 2. 메서드 이름, 반환 타입, 매개변수가 부모 클래스의 메서드와 동일하게 작성
...
// 2. 재사용성과 확장성 향상
// : 기존 코드를 변경하지 않고, 새로운 기능을 추가하거나 기존 기능을 변경
...
public class Overriding {
	public static void main(String[] args) {
		...
		// - 메서드 이름은 같아야 하지만 매개변수의 타입, 개수 순서 중 적어도 하나는 달라야한다.
		// 메서드의 동작을 다양항 상황에 맞게 조정
