...
public class B_List {
	public static void main(String[] args) {
		...
		System.out.println(linkedList);	// Apple, Banana, Apple
		
		linkedList.add(1,"Melon");
		System.out.println(linkedList);	// Apple Melon Banana Apple
		
		String fruitElement = linkedList.get(2);
		System.out.println(fruitElement); //Banana
		
		System.out.println(linkedList.remove(0));	//Apple
		System.out.println(linkedList);	//Melon Banana Apple
		
		System.out.println(linkedList.set(1, "Orange"));
		System.out.println(linkedList);	//Melon Orange Apple
		
		System.out.println(linkedList.size());
		
		System.out.println(linkedList.contains(fruitElement));
	}
}
